...
exports["test vrf verify"] = function(assert) {
  var pk = [
    28,149,90,106,83,99,227,227,211,89,29,250,220,141,17,203,
  ...
  var index = [
    96,43,9,174,212,169,113,184,98,128,48,210,186,218,171,
    145,115,82,29,23,177,126,63,169,232,125,248,165,91,134,76,32
  ];
  var indexArr = ctypes.unsigned_char.array()(index);
  var proof = [
    213,244,36,141,83,73,206,202,94,3,40,174,237,156,101,
  ...
  assert.equal(libCONIKS.cgoVerifyVrf(
    pkArr, pk.length, mArr, m.length, indexArr,
    index.length, proofArr, proof.length
  ), 1);
};
